...
function walk(dir, remainingParts, results, root, excludes) {
    ...
    try {
        ...
        for (const entry of entries) {
            if (entry.name.startsWith('.') && part !== entry.name)
                continue; // skip hidden unless matched
...
export function simpleGlob(pattern, cwd) {
